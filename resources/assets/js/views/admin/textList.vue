  ...
  extends: AppComponent,
    ...
    methods: {
        ...
        setMessageRead(data,index){
            let href = BASE_URL+'admin-api/schedule-change-status/'+data.olog_time+'/'+data.account_id+'/'+data.did+'/'+data.client_number+'/'+data.callid+'/R';
        ...
        fetchTextList(page_url) {
            this.$validator.validateAll().then((result) => {
                if(result == true){
                    page_url = page_url || BASE_URL+'admin-api/inbound-list?page='+this.pagination.current_page+'&per_page='+this.pagination.per_page+this.searchQueryStr;
