...
export default {
    ...
    methods: {
        ...
        fetchContactsList(page_url) {            
            page_url = page_url || 'api/contact-list-modal-filter/'+this.$route.params.group_id+'?page='+this.pagination.current_page+this.searchQueryStr;
        ...
        insertContact (){
            if(this.selectAll){
                let url = 'api/contact-list-modal-filter-selectall/'+this.$route.params.group_id+'?'+this.searchQueryStr;
