                                    ...
                                    <div class="m-form m-form--fit">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                &nbsp;&nbsp;
                                                <button class="btn btn-secondary m-btn m-btn--icon" @click="fetchContacts('api/contact-list?page=1'+'&per_page='+pagination.per_page),resetsearchKey()" id="m_reset">
                                                    <span>
...
export default {
  extends: AppComponent,
    ...
    mounted() { 
        ...
        $("button[id='download_csv']").click(function() {
            alert("ready!");
        });
    },
    methods: {
        ...
        fetchContacts(page_url) {
            page_url = page_url || 'api/contact-list?page='+this.pagination.current_page+'&per_page='+this.pagination.per_page+this.searchQueryStr;
            this.getPagiData(page_url);
        },

        deleteUser(id, index){
            var self = this;
            this.$deletePagiItem(self.data.data, index, self.pagination, 'Are you sure you want to delete this list?', 'api/contacts/' + id);
        }
    },
