                                    ...
                                    <tbody>
                                        <tr v-for="(template, index) in data.data" v-bind:key="template.id">
                                            ...
                                            <td> 
                                                ...
                                                <router-link href="#"  v-bind:to="{name: 'TemplateEdit', params: {id:template.id}}" class="text-info" data-toggle="m-tooltip" title="Edit">
  ...
  extends: AppComponent,
    ...
    methods: {
        ...
        fetchTemplates(page_url) {
            page_url = page_url || 'api/templates?page='+this.pagination.current_page;
            this.getPagiData(page_url);
        },

        deleteTemplate(id, index){
            var self = this;
            this.$deletePagiItem(self.data.data, index, self.pagination, 'Are you sure you want to delete this template?', 'api/templates/' + id);
        }
    },
